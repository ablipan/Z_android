...
package wheelview.spinnerwheel;
...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected static final int DEF_SELECTION_DIVIDER_ACTIVE_ALPHA = 60;

    protected static final int DEF_SELECTION_DIVIDER_DIMMED_ALPHA = 60;
...
//        mSelectionDivider = a.getDrawable(R.styleable.AbstractWheelView_selectionDivider);
        ...
        //滚轮分割线
        mSelectionDivider = getResources().getDrawable(R.drawable.wheel_divider);
